...
impl Game {
    ...
    fn contains_player(&self, player_id: &PlayerId) -> bool {
    ...
    fn get_last_activity_time(&self) -> &SystemTime {
...
#[cfg(test)]
mod tests {
    use super::super::helper::get_answer_fields_from_black_card_in_round;
    use super::*;
